...
/**
 * Define the name of the table that is used to store sessions info.
 * @see login.php
 * @since 0.1
 */
...
/**
 * Define the name of the table that is used to store productes.
 * @since 0.1
 */
define('PRODUCT_TABLE_NAME', 'Product');

/**
 * Define the name of the table that is used to store provdiers.
 * @since 0.1
 */
define('PROVIDER_TABLE_NAME', 'Provider');

/**
 * Define the name of the table that is used to store services.
 * @since 0.1
 */
define('SERVICE_TABLE_NAME', 'Service');
