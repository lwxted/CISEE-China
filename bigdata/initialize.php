...
// Initialize the global User object, which can be accessed using global $user;
init_user_object();

// Initialize the global PPAccessor object, which can be accessed using global $ppaccess;
init_ppaccess_object();

// Initialize the global Service object, which can be accessed using global $service;
init_service_object();
?>